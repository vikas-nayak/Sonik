...
export default function RedesignedSignInPage() {
  return (
                ...
                <SignIn.Step name="start">
                  <div className="relative mb-8">
                    <Card className="relative bg-blue-700/90 backdrop-blur-sm border-none shadow-[8px_8px_0px_0px_rgba(250,204,21,100)] hover:shadow-[16px_16px_0px_0px_rgba(250,204,0,1)] transition-all">
                      <CardHeader>
                        <CardTitle className="text-2xl font-bold text-yellow-200">Sign in to Sonik</CardTitle>
                        <CardDescription className="text-yellow-200/70">Welcome back! Please sign in to continue</CardDescription>
                      </CardHeader>
                      ...
                      <CardFooter className="flex flex-col space-y-4">
                        ...
                        <Button variant="link" size="sm" asChild className="text-yellow-200 hover:text-yellow-300">
                          <Link href="/auth/sign-up">Do not have an account? Sign up</Link>
                        </Button>
                      </CardFooter>
                    </Card>
                  </div>
                ...
                <SignIn.Step name="choose-strategy">
                  <div className="relative mb-8">
                    <Card className="relative bg-blue-950/90 backdrop-blur-sm border-none shadow-[4px_4px_0px_0px_rgba(250,204,21,1)] hover:shadow-[8px_8px_0px_0px_rgba(250,204,21,1)] transition-all">
                      <CardHeader>
                        <CardTitle className="text-2xl font-bold text-yellow-200">Use another method</CardTitle>
                      ...
                      <CardContent className="space-y-4">
                        <SignIn.SupportedStrategy name="email_code" asChild>
                          <Button 
                            type="button" 
                            variant="outline" 
                            className="w-full bg-transparent border-yellow-200/20 text-yellow-200 hover:bg-yellow-200/10"
                            disabled={isGlobalLoading}
                          >
                            Email code
                          </Button>
                      ...
                      <CardFooter>
                        <SignIn.Action navigate="previous" asChild>
                          <Button 
                            className="w-full bg-yellow-200 text-blue-950 hover:bg-yellow-300" 
                            disabled={isGlobalLoading}
                          >
                            <Clerk.Loading>
                              {(isLoading) => isLoading ? <LoaderCircle className="w-4 h-4 animate-spin" /> : 'Go back'}
                            </Clerk.Loading>
                          </Button>
                        </SignIn.Action>
                      </CardFooter>
                ...
                <SignIn.Step name="verifications">
                  <SignIn.Strategy name="password">
                    <div className="relative mb-8">
                      <Card className="relative bg-blue-950/90 backdrop-blur-sm border-none shadow-[4px_4px_0px_0px_rgba(250,204,21,1)] hover:shadow-[8px_8px_0px_0px_rgba(250,204,21,1)] transition-all">
                        <CardHeader>
                          <CardTitle className="text-2xl font-bold text-yellow-200">Enter your password</CardTitle>
                          <CardDescription className="text-yellow-200/70">
                  ...
                  <SignIn.Strategy name="email_code">
                    <div className="relative mb-8">
                      <Card className="relative bg-blue-950/90 backdrop-blur-sm border-none shadow-[4px_4px_0px_0px_rgba(250,204,21,1)] hover:shadow-[8px_8px_0px_0px_rgba(250,204,21,1)] transition-all">
                        <CardHeader>
                          <CardTitle className="text-2xl font-bold text-yellow-200">Check your email</CardTitle>
                          <CardDescription className="text-yellow-200/70">
